...
<head>
    <meta charset="UTF-8">
    <title>Verifikasi Coustumer</title>
    ...
    <div class="col-lg-12">
        <div class="card card-outline-warning mb-3">
            <div class="card-header bg-warning">
                Data Costumer Belum Verifikasi / Di Tolak
            </div>
            <!-- /.panel-heading -->
            <div class="card-block">
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example2">
                    ...
                    <tbody>
                      ...
                      $i=0;
                      $query = mysqli_query($con,"select * from costumer  where verifikasi='0' or  verifikasi='2'");
                      ...
                      ?>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td class="center"><a href="detail_costumer.php?id=<?php echo $data['id_costumer'];?>"><button type="button" class="btn btn-warning btn-xs">Detail</button></td>
                            <td><?php

                            if($data['verifikasi']==0){
                              echo'<span class="badge badge-pill badge-warning badge-sm">Belum</span>';
                            }else if($data['verifikasi']==2){
                              echo'<span class="badge badge-pill badge-danger badge-sm">Ditolak</span>';
                            }
    ...
    <div class="col-lg-12">
        <div class="card card-outline-info mb-3">
            <div class="card-header bg-info">
                Data Costumer Sudah Verifikasi
            </div>
            <!-- /.panel-heading -->
            <div class="card-block">
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example3">
                    ...
                    <tbody>
                      ...
                      include 'share/db.php';
                      $i=0;
                      $query = mysqli_query($con,"select * from costumer  where verifikasi='1' ");
                      while($data = mysqli_fetch_array($query)){
                        $i++;
