...
<form action="proses/edit_password_costumer.php?id=<?php echo $data['id_costumer']?>" method="post" enctype="multipart/form-data" class="post-job">
    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="ulangi_password_baru"  class="form-control" placeholder="ulangi_password_baru">
                                </div>
                            </div>
                        </div>
