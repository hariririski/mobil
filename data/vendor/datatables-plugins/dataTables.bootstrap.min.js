...
*/
(function(){var f=function(c,b){c.extend(!0,b.defaults,{dom:"<'col-sm-12'<'col-sm-6'l><'col-sm-6'f>><'col-sm-12'<'col-sm-12'tr>><'col-sm-12'<'col-sm-12'i><'col-sm-12'p>>",renderer:"bootstrap"});c.extend(b.ext.classes,{sWrapper:"dataTables_wrapper form-inline dt-bootstrap",sFilterInput:"form-control input-sm",sLengthSelect:"form-control input-sm"});b.ext.renderer.pageButton.bootstrap=function(g,f,p,k,h,l){var q=new b.Api(g),r=g.oClasses,i=g.oLanguage.oPaginate,d,e,o=function(b,f){var j,m,n,a,k=function(a){a.preventDefault();
